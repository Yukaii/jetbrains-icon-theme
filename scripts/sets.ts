...
export const sets: IconSet[] = [
  {
    name: 'icons-jetbrains',
    display: 'Jetbrains',
    icons: {
      'codicon:account': 'AllIcons.CodeWithMe.Users',
      'codicon:activate-breakpoints': 'AllIcons.Debugger.ViewBreakpoints',
      'codicon:add': 'AllIcons.General.Add',
      'codicon:alert': 'AllIcons.General.BalloonError',
      // 'codicon:archive': 'MpsIcons35.Archive',
      'codicon:array': 'AllIcons.Json.Array',
      // 'codicon:arrow-both': 'carbon:pan-horizontal',
      'codicon:arrow-down': 'AllIcons.Chooser.Bottom',
      'codicon:arrow-left': 'AllIcons.Chooser.Left',
      'codicon:arrow-right': 'AllIcons.Chooser.Right',
      ...
      'codicon:arrow-up': 'AllIcons.Chooser.Top',
      ...
      'codicon:symbol-array': 'AllIcons.Json.Array',
